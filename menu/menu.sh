...
echo -e "${BIYellow}□ AutoScript By T.K.T = ${RED}( ${BIYellow}TARAP KUHING TUNNELING )${NC}"

echo -e "${BICyan} ┌─────────────────────────────────────────────────────┐${NC}"
echo -e "${BICyan} │                  ${BIWhite}${UWhite}TARAP KUHING TUNELING                          ${BICyan}|${NC}"
echo -e "${BICyan} │                                                                                    ${BICyan}|${NC}"
echo -e " ${BICyan}│  ${BICyan}Use Core        :  ${IPurple}XRAY                                        ${BICyan}|${NC}"

...
printf "q\n" | rclone config
wget -O /root/.config/rclone/rclone.conf "https://raw.githubusercontent.com/Tarap-Kuhing/v/main/backup/rclone.conf"
...
cd /usr/bin
wget -O autobackup "https://raw.githubusercontent.com/Tarap-Kuhing/v/main/backup/autobackup.sh"

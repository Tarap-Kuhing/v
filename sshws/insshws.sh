...
wget -O /etc/systemd/system/ws-dropbear.service https://raw.githubusercontent.com/Tarap-Kuhing/v/main/sshws/ws-dropbear.service && chmod +x /etc/systemd/system/ws-dropbear.service
